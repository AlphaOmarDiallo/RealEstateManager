...
object SampleProperties {
    ...
    val samplePropertyList = listOf(
        com.example.realestatemanager.data.model.Property(
            ...
            null, "50 avenue Hoche 75017 Paris", null, "On sale", 1657490400000,
            null, agents[0].id
        ),
        com.example.realestatemanager.data.model.Property(
            0, "House", 1000000, 400, 15, "Super house in Paris",
            null, "100 avenue Hoche 75017 Paris", null, "On sale", 1657490400000,
            null, agents[1].id
        ),
        com.example.realestatemanager.data.model.Property(
            0, "Penthouse", 900000, 300, 5, "Super penthouse in Paris",
            null, "490 avenue Hoche 75017 Paris", null, "On sale", 1657490400000,
            null, agents[2].id
        ),
        com.example.realestatemanager.data.model.Property(
            0, "Villa", 1200000, 367, 8, "Super villa in Paris",
            null, "130 avenue Hoche 75017 Paris", null, "On sale", 1657490400000,
            null, agents[3].id
        ),
        com.example.realestatemanager.data.model.Property(
